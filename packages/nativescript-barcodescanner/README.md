...
Huge thanks to @EddyVerbruggen for creating the initial version of this plugin.

This plugin must be used only for legacy/quick migration purposes. For a more robust solution please check [MLKit](https://github.com/NativeScript/mlkit).
...
```
tns plugin add @valor/nativescript-barcodescanner
```
...
### XML
```xml
<Page xmlns="http://schemas.nativescript.org/tns.xsd" xmlns:Barcode="@valor/nativescript-barcodescanner">
```
...
registerElement("BarcodeScanner", () => require("@valor/nativescript-barcodescanner").BarcodeScannerView);
```
...
```typescript
Vue.registerElement('BarcodeScanner', () => require('@valor/nativescript-barcodescanner').BarcodeScannerView)
```
...
#### JavaScript
```js
  var BarcodeScanner = require("@valor/nativescript-barcodescanner").BarcodeScanner;
...
#### JavaScript
```js
  var barcodescanner = require("@valor/nativescript-barcodescanner");
