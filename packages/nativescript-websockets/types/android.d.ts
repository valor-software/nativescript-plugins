declare module okhttp3 {
	export class Address {
		...
		/** @deprecated */
		public  __deprecated_proxyAuthenticator(): okhttp3.Authenticator;
		/** @deprecated */
		public  __deprecated_proxy(): java.net.Proxy;
		...
		/** @deprecated */
		public  __deprecated_proxySelector(): java.net.ProxySelector;
		public certificatePinner(): okhttp3.CertificatePinner;
		/** @deprecated */
		public  __deprecated_protocols(): java.util.List<okhttp3.Protocol>;
		...
		/** @deprecated */
		public  __deprecated_sslSocketFactory(): javax.net.ssl.SSLSocketFactory;
		/** @deprecated */
		public  __deprecated_certificatePinner(): okhttp3.CertificatePinner;
		/** @deprecated */
		public  __deprecated_url(): okhttp3.HttpUrl;
		public proxySelector(): java.net.ProxySelector;
		public url(): okhttp3.HttpUrl;
		public toString(): string;
		/** @deprecated */
		public  __deprecated_connectionSpecs(): java.util.List<okhttp3.ConnectionSpec>;
		/** @deprecated */
		public  __deprecated_dns(): okhttp3.Dns;
		public socketFactory(): javax.net.SocketFactory;
		/** @deprecated */
		public  __deprecated_hostnameVerifier(): javax.net.ssl.HostnameVerifier;
		/** @deprecated */
		public  __deprecated_socketFactory(): javax.net.SocketFactory;
	}
}
...
declare module okhttp3 {
	export class Cache {
		...
		/** @deprecated */
		public  __deprecated_directory(): java.io.File;
...
declare module okhttp3 {
	export class CacheControl {
		...
		/** @deprecated */
		public  __deprecated_mustRevalidate(): boolean;
		...
		/** @deprecated */
		public  __deprecated_maxAgeSeconds(): number;
		/** @deprecated */
		public  __deprecated_sMaxAgeSeconds(): number;
		/** @deprecated */
		public  __deprecated_noTransform(): boolean;
		/** @deprecated */
		public  __deprecated_noStore(): boolean;
		public minFreshSeconds(): number;
		public onlyIfCached(): boolean;
		public noCache(): boolean;
		public noTransform(): boolean;
		/** @deprecated */
		public  __deprecated_minFreshSeconds(): number;
		/** @deprecated */
		public  __deprecated_onlyIfCached(): boolean;
		public isPrivate(): boolean;
		/** @deprecated */
		public  __deprecated_noCache(): boolean;
		public immutable(): boolean;
		/** @deprecated */
		public  __deprecated_immutable(): boolean;
		public sMaxAgeSeconds(): number;
		/** @deprecated */
		public  __deprecated_maxStaleSeconds(): number;
...
declare module okhttp3 {
	export class CertificatePinner {
		...
		public check$okhttp(param0: string, param1: kotlin.jvm.functions.Function0<any>): void;
...
declare module okhttp3 {
	export class Challenge {
		...
		/** @deprecated */
		public  __deprecated_scheme(): string;
		public toString(): string;
		...
		/** @deprecated */
		public  __deprecated_charset(): java.nio.charset.Charset;
		/** @deprecated */
		public  __deprecated_authParams(): java.util.Map<string,string>;
		public hashCode(): number;
		/** @deprecated */
		public  __deprecated_realm(): string;
	}
}
...
declare module okhttp3 {
	export class CipherSuite {
		...
		/** @deprecated */
		public  __deprecated_javaName(): string;
		public toString(): string;
	}
...
declare module okhttp3 {
	export class ConnectionSpec {
		...
		/** @deprecated */
		public  __deprecated_supportsTlsExtensions(): boolean;
		...
		public toString(): string;
		/** @deprecated */
		public  __deprecated_cipherSuites(): java.util.List<okhttp3.CipherSuite>;
		public hashCode(): number;
		...
		/** @deprecated */
		public  __deprecated_tlsVersions(): java.util.List<okhttp3.TlsVersion>;
...
declare module okhttp3 {
	export class Cookie {
		...
		/** @deprecated */
		public  __deprecated_hostOnly(): boolean;
		/** @deprecated */
		public  __deprecated_expiresAt(): number;
		public httpOnly(): boolean;
		/** @deprecated */
		public  __deprecated_path(): string;
		public expiresAt(): number;
		/** @deprecated */
		public  __deprecated_name(): string;
		public toString$okhttp(param0: boolean): string;
		public hashCode(): number;
		/** @deprecated */
		public  __deprecated_persistent(): boolean;
		/** @deprecated */
		public  __deprecated_domain(): string;
		public secure(): boolean;
		/** @deprecated */
		public  __deprecated_httpOnly(): boolean;
		public domain(): string;
		public static parseAll(param0: okhttp3.HttpUrl, param1: okhttp3.Headers): java.util.List<okhttp3.Cookie>;
		/** @deprecated */
		public  __deprecated_secure(): boolean;
		public toString(): string;
		/** @deprecated */
		public  __deprecated_value(): string;
...
declare module okhttp3 {
	export class Dispatcher {
		...
		/** @deprecated */
		public  __deprecated_executorService(): java.util.concurrent.ExecutorService;
...
declare module okhttp3 {
	export class FormBody extends okhttp3.RequestBody {
		...
		public contentLength(): number;
		/** @deprecated */
		public  __deprecated_size(): number;
	}
...
declare module okhttp3 {
	export class Handshake {
		...
		/** @deprecated */
		public  __deprecated_tlsVersion(): okhttp3.TlsVersion;
		public equals(param0: any): boolean;
		...
		/** @deprecated */
		public  __deprecated_cipherSuite(): okhttp3.CipherSuite;
		public static get(param0: javax.net.ssl.SSLSession): okhttp3.Handshake;
		/** @deprecated */
		public  __deprecated_peerPrincipal(): java.security.Principal;
		/** @deprecated */
		public  __deprecated_localPrincipal(): java.security.Principal;
		...
		public hashCode(): number;
		/** @deprecated */
		public  __deprecated_localCertificates(): java.util.List<java.security.cert.Certificate>;
		public localPrincipal(): java.security.Principal;
		public tlsVersion(): okhttp3.TlsVersion;
		/** @deprecated */
		public  __deprecated_peerCertificates(): java.util.List<java.security.cert.Certificate>;
	...
	export module Handshake {
		export class Companion {
			...
			/** @deprecated */
			public  __deprecated_get(param0: javax.net.ssl.SSLSession): okhttp3.Handshake;
		}
	}
}
...
declare module okhttp3 {
	...
	export module Headers {
		...
		export class Companion {
			...
			/** @deprecated */
			public  __deprecated_of(param0: androidNative.Array<string>): okhttp3.Headers;
			public of(param0: java.util.Map<string,string>): okhttp3.Headers;
			public of(param0: androidNative.Array<string>): okhttp3.Headers;
			/** @deprecated */
			public  __deprecated_of(param0: java.util.Map<string,string>): okhttp3.Headers;
		}
	}
}
...
declare module okhttp3 {
	export class HttpUrl {
		...
		/** @deprecated */
		public  __deprecated_queryParameterNames(): java.util.Set<string>;
		public queryParameterNames(): java.util.Set<string>;
		/** @deprecated */
		public  __deprecated_port(): number;
		public encodedPassword(): string;
		public query(): string;
		/** @deprecated */
		public  __deprecated_pathSegments(): java.util.List<string>;
		/** @deprecated */
		public  __deprecated_username(): string;
		/** @deprecated */
		public  __deprecated_encodedUsername(): string;
		public static get(param0: string): okhttp3.HttpUrl;
		public pathSize(): number;
		public isHttps(): boolean;
		/** @deprecated */
		public  __deprecated_host(): string;
		...
		/** @deprecated */
		public  __deprecated_encodedPathSegments(): java.util.List<string>;
		...
		/** @deprecated */
		public  __deprecated_pathSize(): number;
		/** @deprecated */
		public  __deprecated_encodedPath(): string;
		public encodedUsername(): string;
		public queryParameterValues(param0: string): java.util.List<string>;
		/** @deprecated */
		public  __deprecated_fragment(): string;
		public newBuilder(param0: string): okhttp3.HttpUrl.Builder;
		/** @deprecated */
		public  __deprecated_query(): string;
		public pathSegments(): java.util.List<string>;
		public static parse(param0: string): okhttp3.HttpUrl;
		/** @deprecated */
		public  __deprecated_url(): java.net.URL;
		/** @deprecated */
		public  __deprecated_encodedPassword(): string;
		/** @deprecated */
		public  __deprecated_querySize(): number;
	...
	export module HttpUrl {
		...
		export class Companion {
			...
			/** @deprecated */
			public  __deprecated_parse(param0: string): okhttp3.HttpUrl;
			...
			/** @deprecated */
			public  __deprecated_get(param0: string): okhttp3.HttpUrl;
			...
			/** @deprecated */
			public  __deprecated_get(param0: java.net.URL): okhttp3.HttpUrl;
			/** @deprecated */
			public  __deprecated_get(param0: java.net.URI): okhttp3.HttpUrl;
		}
	}
}
...
declare module okhttp3 {
	export class MediaType {
		...
		public toString(): string;
		/** @deprecated */
		public  __deprecated_type(): string;
		/** @deprecated */
		public  __deprecated_subtype(): string;
	}
	export module MediaType {
		export class Companion {
			...
			/** @deprecated */
			public  __deprecated_parse(param0: string): okhttp3.MediaType;
			/** @deprecated */
			public  __deprecated_get(param0: string): okhttp3.MediaType;
		}
	}
}
...
declare module okhttp3 {
	export class MultipartBody extends okhttp3.RequestBody {
		...
		public constructor();
		/** @deprecated */
		public  __deprecated_type(): okhttp3.MediaType;
		/** @deprecated */
		public  __deprecated_boundary(): string;
		...
		public size(): number;
		/** @deprecated */
		public  __deprecated_parts(): java.util.List<okhttp3.MultipartBody.Part>;
		public contentType(): okhttp3.MediaType;
	...
	export module MultipartBody {
		...
		export class Part {
			...
			/** @deprecated */
			public  __deprecated_headers(): okhttp3.Headers;
			/** @deprecated */
			public  __deprecated_body(): okhttp3.RequestBody;
...
declare module okhttp3 {
	export class OkHttpClient implements okhttp3.Call.Factory, okhttp3.WebSocket.Factory {
		...
		public  __deprecated_proxyAuthenticator(): okhttp3.Authenticator;
		/** @deprecated */
		public  __deprecated_callTimeoutMillis(): number;
		public connectionPool(): okhttp3.ConnectionPool;
		public cache(): okhttp3.Cache;
		/** @deprecated */
		public  __deprecated_protocols(): java.util.List<okhttp3.Protocol>;
		/** @deprecated */
		public  __deprecated_dispatcher(): okhttp3.Dispatcher;
		public dns(): okhttp3.Dns;
		public proxyAuthenticator(): okhttp3.Authenticator;
		public hostnameVerifier(): javax.net.ssl.HostnameVerifier;
		...
		/** @deprecated */
		public  __deprecated_networkInterceptors(): java.util.List<okhttp3.Interceptor>;
		/** @deprecated */
		public  __deprecated_sslSocketFactory(): javax.net.ssl.SSLSocketFactory;
		public constructor();
		...
		/** @deprecated */
		public  __deprecated_connectTimeoutMillis(): number;
		/** @deprecated */
		public  __deprecated_dns(): okhttp3.Dns;
		public socketFactory(): javax.net.SocketFactory;
		...
		/** @deprecated */
		public  __deprecated_interceptors(): java.util.List<okhttp3.Interceptor>;
		public certificateChainCleaner(): okhttp3.internal.tls.CertificateChainCleaner;
		public protocols(): java.util.List<okhttp3.Protocol>;
		/** @deprecated */
		public  __deprecated_followSslRedirects(): boolean;
		/** @deprecated */
		public  __deprecated_writeTimeoutMillis(): number;
		/** @deprecated */
		public  __deprecated_cache(): okhttp3.Cache;
		/** @deprecated */
		public  __deprecated_connectionPool(): okhttp3.ConnectionPool;
		/** @deprecated */
		public  __deprecated_retryOnConnectionFailure(): boolean;
		public minWebSocketMessageToCompress(): number;
		public cookieJar(): okhttp3.CookieJar;
		public pingIntervalMillis(): number;
		/** @deprecated */
		public  __deprecated_pingIntervalMillis(): number;
		public connectionSpecs(): java.util.List<okhttp3.ConnectionSpec>;
		/** @deprecated */
		public  __deprecated_eventListenerFactory(): okhttp3.EventListener.Factory;
		/** @deprecated */
		public  __deprecated_certificatePinner(): okhttp3.CertificatePinner;
		public proxySelector(): java.net.ProxySelector;
		/** @deprecated */
		public  __deprecated_cookieJar(): okhttp3.CookieJar;
		public readTimeoutMillis(): number;
		public authenticator(): okhttp3.Authenticator;
		public getRouteDatabase(): okhttp3.internal.connection.RouteDatabase;
		/** @deprecated */
		public  __deprecated_authenticator(): okhttp3.Authenticator;
		public writeTimeoutMillis(): number;
		/** @deprecated */
		public  __deprecated_connectionSpecs(): java.util.List<okhttp3.ConnectionSpec>;
		...
		/** @deprecated */
		public  __deprecated_readTimeoutMillis(): number;
		/** @deprecated */
		public  __deprecated_followRedirects(): boolean;
	...
	export module OkHttpClient {
		export class Builder {
			...
			public __addNetworkInterceptor(param0: kotlin.jvm.functions.Function1<any,okhttp3.Response>): okhttp3.OkHttpClient.Builder;
			...
			public __addInterceptor(param0: kotlin.jvm.functions.Function1<any,okhttp3.Response>): okhttp3.OkHttpClient.Builder;
...
declare module okhttp3 {
	export class Request {
		...
		public  __deprecated_body(): okhttp3.RequestBody;
		/** @deprecated */
		public  __deprecated_cacheControl(): okhttp3.CacheControl;
		/** @deprecated */
		public  __deprecated_method(): string;
...
declare module okhttp3 {
	export class Response {
		...
		public handshake(): okhttp3.Handshake;
		/** @deprecated */
		public  __deprecated_request(): okhttp3.Request;
		/** @deprecated */
		public  __deprecated_code(): number;
		public header(param0: string, param1: string): string;
		public header(param0: string): string;
		/** @deprecated */
		public  __deprecated_priorResponse(): okhttp3.Response;
		/** @deprecated */
		public  __deprecated_networkResponse(): okhttp3.Response;
		...
		public protocol(): okhttp3.Protocol;
		/** @deprecated */
		public  __deprecated_protocol(): okhttp3.Protocol;
		/** @deprecated */
		public  __deprecated_headers(): okhttp3.Headers;
		public priorResponse(): okhttp3.Response;
		/** @deprecated */
		public  __deprecated_body(): okhttp3.ResponseBody;
		...
		/** @deprecated */
		public  __deprecated_sentRequestAtMillis(): number;
		public toString(): string;
		public isSuccessful(): boolean;
		/** @deprecated */
		public  __deprecated_receivedResponseAtMillis(): number;
		/** @deprecated */
		public  __deprecated_cacheResponse(): okhttp3.Response;
		public headers(param0: string): java.util.List<string>;
		public newBuilder(): okhttp3.Response.Builder;
		/** @deprecated */
		public  __deprecated_message(): string;
		public message(): string;
		public challenges(): java.util.List<okhttp3.Challenge>;
		public receivedResponseAtMillis(): number;
		public isRedirect(): boolean;
		/** @deprecated */
		public  __deprecated_handshake(): okhttp3.Handshake;
	}
...
declare module okhttp3 {
	export class Route {
		...
		public hashCode(): number;
		/** @deprecated */
		public  __deprecated_socketAddress(): java.net.InetSocketAddress;
		public toString(): string;
		/** @deprecated */
		public  __deprecated_address(): okhttp3.Address;
...
declare module okhttp3 {
	export module internal {
		export class Util {
			...
			public static filterList(param0: java.lang.Iterable, param1: kotlin.jvm.functions.Function1): java.util.List;
...
declare module okhttp3 {
	export module internal {
		export module ws {
			export class MessageDeflaterKt {
...
declare module okhttp3 {
	export module internal {
		export module ws {
			export class MessageInflaterKt {
...
declare module okio {
	export class __Base64 {
		public static class: java.lang.Class<okio.__Base64>;
		public static decodeBase64ToArray(param0: string): androidNative.Array<number>;
		public static encodeBase64(param0: androidNative.Array<number>, param1: androidNative.Array<number>): string;
		public static getBASE64_URL_SAFE(): androidNative.Array<number>;
		public static getBASE64(): androidNative.Array<number>;
	}
}

declare module okio {
	export class __DeflaterSinkExtensions {
		public static class: java.lang.Class<okio.__DeflaterSinkExtensions>;
		public static deflate(param0: okio.Sink, param1: java.util.zip.Deflater): okio.DeflaterSink;
	}
}

declare module okio {
	export class  __deprecatedOkio {
		public static class: java.lang.Class<okio. __deprecatedOkio>;
		public static INSTANCE: okio. __deprecatedOkio;
		/** @deprecated */
...
declare module okio {
	export class  __deprecatedUpgrade {
		public static class: java.lang.Class<okio. __deprecatedUpgrade>;
		public static getOkio(): okio. __deprecatedOkio;
		public static getUtf8(): okio. __deprecatedUtf8;
	}
}

declare module okio {
	export class  __deprecatedUtf8 {
		public static class: java.lang.Class<okio. __deprecatedUtf8>;
		public static INSTANCE: okio. __deprecatedUtf8;
		/** @deprecated */
...
declare module okio {
	export class __GzipSinkExtensions {
		public static class: java.lang.Class<okio.__GzipSinkExtensions>;
		public static gzip(param0: okio.Sink): okio.GzipSink;
	}
}

declare module okio {
	export class __GzipSourceExtensions {
		public static class: java.lang.Class<okio.__GzipSourceExtensions>;
		public static gzip(param0: okio.Source): okio.GzipSource;
	}
}

declare module okio {
	export class __InflaterSourceExtensions {
		public static class: java.lang.Class<okio.__InflaterSourceExtensions>;
		public static inflate(param0: okio.Source, param1: java.util.zip.Inflater): okio.InflaterSource;
	}
}

declare module okio {
	export class __Platform {
		public static class: java.lang.Class<okio.__Platform>;
		public static asUtf8ToByteArray(param0: string): androidNative.Array<number>;
		public static toUtf8String(param0: androidNative.Array<number>): string;
		public static synchronized(param0: any, param1: kotlin.jvm.functions.Function0): any;
	}
}

declare module okio {
	export class __Util {
		public static class: java.lang.Class<okio.__Util>;
		public static reverseBytes(param0: number): number;
		public static toHexString(param0: number): string;
		public static shr(param0: number, param1: number): number;
		...
		public static checkOffsetAndCount(param0: number, param1: number, param2: number): void;
		public static shl(param0: number, param1: number): number;
		public static and(param0: number, param1: number): number;
	}
}
...
declare module okio {
	export class AsyncTimeout extends okio.Timeout {
		...
		public constructor();
		public withTimeout(param0: kotlin.jvm.functions.Function0): any;
		public timedOut(): void;
		public newTimeoutException(param0: java.io.IOException): java.io.IOException;
...
declare module okio {
	export class Buffer implements okio.BufferedSource, okio.BufferedSink {
		...
		/** @deprecated */
		public  __deprecated_getByte(param0: number): number;
		/** @deprecated */
...
declare module okio {
	...
	export module ByteString {
		export class Companion {
			...
			/** @deprecated */
			public  __deprecated_of(param0: java.nio.ByteBuffer): okio.ByteString;
			/** @deprecated */
			public  __deprecated_decodeHex(param0: string): okio.ByteString;
			/** @deprecated */
			public  __deprecated_encodeString(param0: string, param1: java.nio.charset.Charset): okio.ByteString;
			/** @deprecated */
			public  __deprecated_decodeBase64(param0: string): okio.ByteString;
			...
			/** @deprecated */
			public  __deprecated_encodeUtf8(param0: string): okio.ByteString;
			public of(param0: java.nio.ByteBuffer): okio.ByteString;
			public read(param0: java.io.InputStream, param1: number): okio.ByteString;
			/** @deprecated */
			public  __deprecated_of(param0: androidNative.Array<number>, param1: number, param2: number): okio.ByteString;
			...
			/** @deprecated */
			public  __deprecated_read(param0: java.io.InputStream, param1: number): okio.ByteString;
		}
	}
}
...
declare module okio {
	export abstract class ForwardingSink extends okio.Sink {
		...
		public write(param0: okio.Buffer, param1: number): void;
		/** @deprecated */
		public  __deprecated_delegate(): okio.Sink;
		public toString(): string;
		public flush(): void;
		public timeout(): okio.Timeout;
	}
...
declare module okio {
	export abstract class ForwardingSource extends okio.Source {
		...
		/** @deprecated */
		public  __deprecated_delegate(): okio.Source;
		public toString(): string;
		public read(param0: okio.Buffer, param1: number): number;
		public timeout(): okio.Timeout;
	}
...
declare module okio {
	export class GzipSink extends okio.Sink {
		...
		public write(param0: okio.Buffer, param1: number): void;
		/** @deprecated */
		public  __deprecated_deflater(): java.util.zip.Deflater;
		public flush(): void;
		public timeout(): okio.Timeout;
	}
}
...
declare module okio {
	export class HashingSink extends okio.ForwardingSink {
		...
		public write(param0: okio.Buffer, param1: number): void;
		/** @deprecated */
		public  __deprecated_hash(): okio.ByteString;
...
declare module okio {
	export class Pipe {
		...
		/** @deprecated */
		public  __deprecated_sink(): okio.Sink;
		public constructor(param0: number);
		...
		/** @deprecated */
		public  __deprecated_source(): okio.Source;
...
declare module okio {
	export class Timeout {
		...
		public deadlineNanoTime(): number;
		public deadlineNanoTime(param0: number): okio.Timeout;
		public intersectWith(param0: okio.Timeout, param1: kotlin.jvm.functions.Function0<kotlin.Unit>): void;
		public clearTimeout(): okio.Timeout;
	}
...
declare module okio {
	export class Utf8 {
		...
		public static process4Utf8Bytes(param0: androidNative.Array<number>, param1: number, param2: number, param3: kotlin.jvm.functions.Function1<any,kotlin.Unit>): number;
		public static size(param0: string, param1: number, param2: number): number;
		public static process2Utf8Bytes(param0: androidNative.Array<number>, param1: number, param2: number, param3: kotlin.jvm.functions.Function1<any,kotlin.Unit>): number;
		public static size(param0: string): number;
		public static size(param0: string, param1: number): number;
		public static processUtf8CodePoints(param0: androidNative.Array<number>, param1: number, param2: number, param3: kotlin.jvm.functions.Function1<any,kotlin.Unit>): void;
		public static processUtf16Chars(param0: androidNative.Array<number>, param1: number, param2: number, param3: kotlin.jvm.functions.Function1<any,kotlin.Unit>): void;
		public static processUtf8Bytes(param0: string, param1: number, param2: number, param3: kotlin.jvm.functions.Function1<any,kotlin.Unit>): void;
		public static isUtf8Continuation(param0: number): boolean;
		public static process3Utf8Bytes(param0: androidNative.Array<number>, param1: number, param2: number, param3: kotlin.jvm.functions.Function1<any,kotlin.Unit>): number;
	}
}

declare module okio {
	export module internal {
		export class BufferKt {
			...
			public static commonReadUtf8Line(param0: okio.Buffer): string;
			public static commonCopyTo(param0: okio.Buffer, param1: okio.Buffer, param2: number, param3: number): okio.Buffer;
			public static commonGet(param0: okio.Buffer, param1: number): number;
			public static commonReadByteString(param0: okio.Buffer): okio.ByteString;
			public static commonEquals(param0: okio.Buffer, param1: any): boolean;
			public static commonCompleteSegmentByteCount(param0: okio.Buffer): number;
			public static commonWriteUtf8CodePoint(param0: okio.Buffer, param1: number): okio.Buffer;
			public static commonWriteShort(param0: okio.Buffer, param1: number): okio.Buffer;
			public static commonClear(param0: okio.Buffer): void;
			public static commonIndexOfElement(param0: okio.Buffer, param1: okio.ByteString, param2: number): number;
			public static seek(param0: okio.Buffer, param1: number, param2: kotlin.jvm.functions.Function2): any;
			public static commonReadFully(param0: okio.Buffer, param1: androidNative.Array<number>): void;
			public static commonReadByteArray(param0: okio.Buffer): androidNative.Array<number>;
			public static commonWriteHexadecimalUnsignedLong(param0: okio.Buffer, param1: number): okio.Buffer;
			public static selectPrefix(param0: okio.Buffer, param1: okio.Options, param2: boolean): number;
			public static commonRead(param0: okio.Buffer, param1: okio.Buffer, param2: number): number;
			public static rangeEquals(param0: okio.Segment, param1: number, param2: androidNative.Array<number>, param3: number, param4: number): boolean;
			public static commonWriteDecimalLong(param0: okio.Buffer, param1: number): okio.Buffer;
			public static commonWriteInt(param0: okio.Buffer, param1: number): okio.Buffer;
			public static commonWriteByte(param0: okio.Buffer, param1: number): okio.Buffer;
			public static commonReadByteArray(param0: okio.Buffer, param1: number): androidNative.Array<number>;
			public static commonReadDecimalLong(param0: okio.Buffer): number;
			public static commonSkip(param0: okio.Buffer, param1: number): void;
			public static commonReadByte(param0: okio.Buffer): number;
			public static commonReadUtf8CodePoint(param0: okio.Buffer): number;
			public static commonWriteAll(param0: okio.Buffer, param1: okio.Source): number;
			public static readUtf8Line(param0: okio.Buffer, param1: number): string;
			public static commonWritableSegment(param0: okio.Buffer, param1: number): okio.Segment;
			public static commonWrite(param0: okio.Buffer, param1: okio.Source, param2: number): okio.Buffer;
			public static commonRead(param0: okio.Buffer, param1: androidNative.Array<number>, param2: number, param3: number): number;
			public static commonHashCode(param0: okio.Buffer): number;
			public static commonWrite(param0: okio.Buffer, param1: okio.Buffer, param2: number): void;
			public static commonReadUtf8(param0: okio.Buffer, param1: number): string;
			public static commonRangeEquals(param0: okio.Buffer, param1: number, param2: okio.ByteString, param3: number, param4: number): boolean;
			public static commonReadHexadecimalUnsignedLong(param0: okio.Buffer): number;
			public static commonReadShort(param0: okio.Buffer): number;
			public static commonWriteLong(param0: okio.Buffer, param1: number): okio.Buffer;
			public static commonSnapshot(param0: okio.Buffer, param1: number): okio.ByteString;
			public static commonSnapshot(param0: okio.Buffer): okio.ByteString;
			public static commonWriteUtf8(param0: okio.Buffer, param1: string, param2: number, param3: number): okio.Buffer;
			public static getHEX_DIGIT_BYTES(): androidNative.Array<number>;
			public static commonSelect(param0: okio.Buffer, param1: okio.Options): number;
			public static commonIndexOf(param0: okio.Buffer, param1: number, param2: number, param3: number): number;
			public static commonCopy(param0: okio.Buffer): okio.Buffer;
			public static commonWrite(param0: okio.Buffer, param1: androidNative.Array<number>): okio.Buffer;
			public static commonReadLong(param0: okio.Buffer): number;
			public static commonReadFully(param0: okio.Buffer, param1: okio.Buffer, param2: number): void;
			public static commonReadInt(param0: okio.Buffer): number;
			public static commonRead(param0: okio.Buffer, param1: androidNative.Array<number>): number;
			public static commonReadAll(param0: okio.Buffer, param1: okio.Sink): number;
			public static commonReadByteString(param0: okio.Buffer, param1: number): okio.ByteString;
			public static commonIndexOf(param0: okio.Buffer, param1: okio.ByteString, param2: number): number;
			public static commonWrite(param0: okio.Buffer, param1: okio.ByteString, param2: number, param3: number): okio.Buffer;
			public static commonWrite(param0: okio.Buffer, param1: androidNative.Array<number>, param2: number, param3: number): okio.Buffer;
			public static commonReadUtf8LineStrict(param0: okio.Buffer, param1: number): string;
		}
	}
}
...
declare module okio {
	export module internal {
		export class ByteStringKt {
			public static class: java.lang.Class<okio.internal.ByteStringKt>;
			public static commonGetSize(param0: okio.ByteString): number;
			public static commonRangeEquals(param0: okio.ByteString, param1: number, param2: okio.ByteString, param3: number, param4: number): boolean;
			public static commonToByteString(param0: androidNative.Array<number>, param1: number, param2: number): okio.ByteString;
			public static commonEndsWith(param0: okio.ByteString, param1: okio.ByteString): boolean;
			public static commonOf(param0: androidNative.Array<number>): okio.ByteString;
			public static commonStartsWith(param0: okio.ByteString, param1: okio.ByteString): boolean;
			public static commonUtf8(param0: okio.ByteString): string;
			public static commonInternalArray(param0: okio.ByteString): androidNative.Array<number>;
			public static commonEncodeUtf8(param0: string): okio.ByteString;
			public static commonBase64Url(param0: okio.ByteString): string;
			public static commonWrite(param0: okio.ByteString, param1: okio.Buffer, param2: number, param3: number): void;
			public static commonEndsWith(param0: okio.ByteString, param1: androidNative.Array<number>): boolean;
			public static commonLastIndexOf(param0: okio.ByteString, param1: okio.ByteString, param2: number): number;
			public static commonEquals(param0: okio.ByteString, param1: any): boolean;
			public static commonHex(param0: okio.ByteString): string;
			public static commonGetByte(param0: okio.ByteString, param1: number): number;
			public static commonToByteArray(param0: okio.ByteString): androidNative.Array<number>;
			public static commonToAsciiUppercase(param0: okio.ByteString): okio.ByteString;
			public static commonRangeEquals(param0: okio.ByteString, param1: number, param2: androidNative.Array<number>, param3: number, param4: number): boolean;
			public static commonIndexOf(param0: okio.ByteString, param1: androidNative.Array<number>, param2: number): number;
			public static commonHashCode(param0: okio.ByteString): number;
			public static commonDecodeHex(param0: string): okio.ByteString;
			public static commonToAsciiLowercase(param0: okio.ByteString): okio.ByteString;
			public static commonDecodeBase64(param0: string): okio.ByteString;
			public static commonSubstring(param0: okio.ByteString, param1: number, param2: number): okio.ByteString;
			public static commonStartsWith(param0: okio.ByteString, param1: androidNative.Array<number>): boolean;
			public static getHEX_DIGIT_CHARS(): androidNative.Array<string>;
			public static commonToString(param0: okio.ByteString): string;
			public static commonBase64(param0: okio.ByteString): string;
			public static commonCompareTo(param0: okio.ByteString, param1: okio.ByteString): number;
			public static commonLastIndexOf(param0: okio.ByteString, param1: androidNative.Array<number>, param2: number): number;
		}
	}
}
...
declare module okio {
	export module internal {
		export class RealBufferedSinkKt {
			public static class: java.lang.Class<okio.internal.RealBufferedSinkKt>;
			public static commonWriteLong(param0: okio.RealBufferedSink, param1: number): okio.BufferedSink;
			public static commonWriteUtf8(param0: okio.RealBufferedSink, param1: string): okio.BufferedSink;
			public static commonClose(param0: okio.RealBufferedSink): void;
			public static commonToString(param0: okio.RealBufferedSink): string;
			public static commonWriteLongLe(param0: okio.RealBufferedSink, param1: number): okio.BufferedSink;
			public static commonWriteUtf8(param0: okio.RealBufferedSink, param1: string, param2: number, param3: number): okio.BufferedSink;
			public static commonWriteShortLe(param0: okio.RealBufferedSink, param1: number): okio.BufferedSink;
			public static commonWriteIntLe(param0: okio.RealBufferedSink, param1: number): okio.BufferedSink;
			public static commonFlush(param0: okio.RealBufferedSink): void;
			public static commonWriteAll(param0: okio.RealBufferedSink, param1: okio.Source): number;
			public static commonWriteShort(param0: okio.RealBufferedSink, param1: number): okio.BufferedSink;
			public static commonWriteByte(param0: okio.RealBufferedSink, param1: number): okio.BufferedSink;
			public static commonWriteDecimalLong(param0: okio.RealBufferedSink, param1: number): okio.BufferedSink;
			public static commonWrite(param0: okio.RealBufferedSink, param1: okio.ByteString, param2: number, param3: number): okio.BufferedSink;
			public static commonTimeout(param0: okio.RealBufferedSink): okio.Timeout;
			public static commonWriteUtf8CodePoint(param0: okio.RealBufferedSink, param1: number): okio.BufferedSink;
			public static commonWrite(param0: okio.RealBufferedSink, param1: okio.Buffer, param2: number): void;
			public static commonWriteHexadecimalUnsignedLong(param0: okio.RealBufferedSink, param1: number): okio.BufferedSink;
			public static commonWrite(param0: okio.RealBufferedSink, param1: okio.ByteString): okio.BufferedSink;
			public static commonWrite(param0: okio.RealBufferedSink, param1: androidNative.Array<number>, param2: number, param3: number): okio.BufferedSink;
			public static commonWrite(param0: okio.RealBufferedSink, param1: okio.Source, param2: number): okio.BufferedSink;
			public static commonEmitCompleteSegments(param0: okio.RealBufferedSink): okio.BufferedSink;
			public static commonEmit(param0: okio.RealBufferedSink): okio.BufferedSink;
			public static commonWrite(param0: okio.RealBufferedSink, param1: androidNative.Array<number>): okio.BufferedSink;
			public static commonWriteInt(param0: okio.RealBufferedSink, param1: number): okio.BufferedSink;
		}
	}
}
...
declare module okio {
	export module internal {
		export class RealBufferedSourceKt {
			public static class: java.lang.Class<okio.internal.RealBufferedSourceKt>;
			public static commonReadAll(param0: okio.RealBufferedSource, param1: okio.Sink): number;
			public static commonReadHexadecimalUnsignedLong(param0: okio.RealBufferedSource): number;
			public static commonRequest(param0: okio.RealBufferedSource, param1: number): boolean;
			public static commonReadByteString(param0: okio.RealBufferedSource, param1: number): okio.ByteString;
			public static commonRequire(param0: okio.RealBufferedSource, param1: number): void;
			public static commonReadUtf8Line(param0: okio.RealBufferedSource): string;
			public static commonExhausted(param0: okio.RealBufferedSource): boolean;
			public static commonReadFully(param0: okio.RealBufferedSource, param1: androidNative.Array<number>): void;
			public static commonTimeout(param0: okio.RealBufferedSource): okio.Timeout;
			public static commonReadLongLe(param0: okio.RealBufferedSource): number;
			public static commonIndexOf(param0: okio.RealBufferedSource, param1: number, param2: number, param3: number): number;
			public static commonIndexOf(param0: okio.RealBufferedSource, param1: okio.ByteString, param2: number): number;
			public static commonReadUtf8CodePoint(param0: okio.RealBufferedSource): number;
			public static commonReadByte(param0: okio.RealBufferedSource): number;
			public static commonReadShort(param0: okio.RealBufferedSource): number;
			public static commonReadDecimalLong(param0: okio.RealBufferedSource): number;
			public static commonReadShortLe(param0: okio.RealBufferedSource): number;
			public static commonSkip(param0: okio.RealBufferedSource, param1: number): void;
			public static commonReadFully(param0: okio.RealBufferedSource, param1: okio.Buffer, param2: number): void;
			public static commonReadUtf8(param0: okio.RealBufferedSource): string;
			public static commonReadByteString(param0: okio.RealBufferedSource): okio.ByteString;
			public static commonReadInt(param0: okio.RealBufferedSource): number;
			public static commonReadIntLe(param0: okio.RealBufferedSource): number;
			public static commonReadLong(param0: okio.RealBufferedSource): number;
			public static commonSelect(param0: okio.RealBufferedSource, param1: okio.Options): number;
			public static commonRead(param0: okio.RealBufferedSource, param1: okio.Buffer, param2: number): number;
			public static commonClose(param0: okio.RealBufferedSource): void;
			public static commonIndexOfElement(param0: okio.RealBufferedSource, param1: okio.ByteString, param2: number): number;
			public static commonRead(param0: okio.RealBufferedSource, param1: androidNative.Array<number>, param2: number, param3: number): number;
			public static commonReadByteArray(param0: okio.RealBufferedSource): androidNative.Array<number>;
			public static commonRangeEquals(param0: okio.RealBufferedSource, param1: number, param2: okio.ByteString, param3: number, param4: number): boolean;
			public static commonPeek(param0: okio.RealBufferedSource): okio.BufferedSource;
			public static commonToString(param0: okio.RealBufferedSource): string;
			public static commonReadUtf8(param0: okio.RealBufferedSource, param1: number): string;
			public static commonReadUtf8LineStrict(param0: okio.RealBufferedSource, param1: number): string;
			public static commonReadByteArray(param0: okio.RealBufferedSource, param1: number): androidNative.Array<number>;
		}
	}
}
...
declare module okio {
	export module internal {
		export class SegmentedByteStringKt {
			public static class: java.lang.Class<okio.internal.SegmentedByteStringKt>;
			public static commonGetSize(param0: okio.SegmentedByteString): number;
			public static commonRangeEquals(param0: okio.SegmentedByteString, param1: number, param2: androidNative.Array<number>, param3: number, param4: number): boolean;
			public static commonRangeEquals(param0: okio.SegmentedByteString, param1: number, param2: okio.ByteString, param3: number, param4: number): boolean;
			public static binarySearch(param0: androidNative.Array<number>, param1: number, param2: number, param3: number): number;
			public static commonInternalGet(param0: okio.SegmentedByteString, param1: number): number;
			public static commonHashCode(param0: okio.SegmentedByteString): number;
			public static forEachSegment(param0: okio.SegmentedByteString, param1: kotlin.jvm.functions.Function3<any,any,any,kotlin.Unit>): void;
			public static segment(param0: okio.SegmentedByteString, param1: number): number;
			public static commonSubstring(param0: okio.SegmentedByteString, param1: number, param2: number): okio.ByteString;
			public static commonToByteArray(param0: okio.SegmentedByteString): androidNative.Array<number>;
			public static commonWrite(param0: okio.SegmentedByteString, param1: okio.Buffer, param2: number, param3: number): void;
			public static commonEquals(param0: okio.SegmentedByteString, param1: any): boolean;
		}
	}
}
...
declare module okio {
	export module internal {
		export class _Utf8Kt {
			public static class: java.lang.Class<okio.internal._Utf8Kt>;
			public static commonAsUtf8ToByteArray(param0: string): androidNative.Array<number>;
			public static commonToUtf8String(param0: androidNative.Array<number>, param1: number, param2: number): string;
		}
	}
}
